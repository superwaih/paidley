            ...
            {/* <PhysicalCard /> */}
           {
            ...
            cardType === "virtual" &&(
             ...
             '>
              ...
              alt=""
            />
            <button className='bg-[#E8F7FD] gap-2  text-brand-color p-3 flex
             items-center'> <AiOutlineEye /> Show card details</button>
              </div>
            )
           }
...
{
                    cardType === "virtual" && (
                      <div className='bg-[#F3F7FA] rounded-md cursor-pointer py-3 px-2 flex justify-between border-[#306BB2] border '>
                        <div className='flex gap-3 items-center'>
                        <div className='rounded-full bg-[#EAF0F6] p-3'>
       <BsCreditCard2Back className="text-[#ACC4E0] text-2xl" />
       </div>
                       
                          <div>
                            <h3 className='font-semibold text-brand-color'>Manage Card</h3>
