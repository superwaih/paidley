...
import Hero from "../../../public/images/features/virtual-hero.png"
import HeroTwo from "../../../public/images/features/virtual-hero-2.png"
  ...
  return (
    ...
    <div className='w-full bg-[#E8F7FD] pt-16 pb-8' >
        ...
        <div className="hero__text w-full  lg:w-1/2 flex flex-col space-y-6">
            <h3 className='text-brand-blue tracking-normal lg:max-w-lg leading-20  font-semibold text-3xl md:text-5xl'>Get Paid Like a Local</h3>
