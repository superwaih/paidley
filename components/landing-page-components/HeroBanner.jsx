  ...
  return (
    <div className='w-full bg-[#E8F7FD] pt-16 pb-8' >
        ...
        <div className="hero__text w-full lg:w-1/2 flex flex-col space-y-6">
            <h3 className='text-brand-blue leading-16 max-w-2xl font-semibold text-3xl md:text-4xl'>Expand your horizons, Invest, spend and exchange currencies globally.</h3>
            ...
            <button className='bg-brand-color flex items-center gap-4 text-white p-4 rounded-[12px] w-fit'>
