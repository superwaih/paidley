  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke={path.includes("accounts") ? "#306BB2" : "#CDDBEC"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M4 10V18.5M8 10V18.5"  stroke={path.includes("accounts") ? "#306BB2" : "#CDDBEC"} 
      
      
      strokeWidth="1.5" />
      <path d="M16 10V18.5M20 10V18.5"  stroke={path.includes("accounts") ? "#306BB2" : "#CDDBEC"} strokeWidth="1.5" />
      <path
